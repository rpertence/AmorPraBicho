...
<div style="width: 180px; text-align: center; line-height: 20px;">
    <img src="<%= string.Format("{0}App_Themes\\ActioAdms\\hd\\produtos\\icones\\{1}", ((Site.BaseUserControl)this).Pagina.CaminhoADMS, this.ImageURL) %>" /><br />
    <span style="font-size: 14px;"><%= this.NomeProduto %><br /></span><br />
    <img src="../App_Themes/Padrao/Imagens/adicionar-ao-carrinho.png" class="ImageComOver" /><br />
