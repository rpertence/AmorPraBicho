...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderAdms" Runat="Server">
    <fieldset style="border: 1px solid #000000; width: 800px; padding: 15px">
        ...
        <legend>                                
            categorias e sub-categorias</legend>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="padding: 4px" valign="middle">
                                                    <asp:Panel ID="PanelSubCategorias" runat="server">
                                                        <br />
                                                        <br />
                                                        sub-categorias:<br /> <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td valign="top" width="50%">
                                                                    listagem das sub-categorias</td>
                                                                <td width="50%">
                                                                    detalhes da sub-categoria</td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="top" width="50%">
                    ...
                    <td style="padding: 5px">
                        ...
                        <asp:Panel ID="PanelDetalhesCliente" runat="server">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="center" style="padding: 5px" valign="middle" width="100px">
                                        &nbsp;</td>
                                    <td align="center" style="padding: 5px" valign="middle">
                        ...
                        <asp:Panel ID="PanelListaVendas" runat="server">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="left" class="azul" width="100px">
                                        &nbsp;</td>
                                    <td style="padding: 5px">
                    ...
                    <td>
                        <asp:Panel ID="PanelEditAnexo" runat="server" Visible="False">
                            <table cellpadding="0" cellspacing="0" class="style6">
                                <tr>
                                    <td style="padding-top: 10px; text-align: right;" valign="middle" width="150">
                                        &nbsp;</td>
            ...
            <asp:Panel ID="PanelDetalheDescricao" runat="server">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="left" style="padding: 5px" valign="middle">
                            &nbsp;<asp:ImageButton ID="ibt_SalvarDescricao" runat="server" ImageAlign="Middle" 
                                ImageUrl="~/App_Themes/ActioAdms/botoes/salvar.png" 
                    ...
                    <tr>
                        <td align="right" style="padding: 5px" valign="middle" width="150px">
                            Título da Descrição:</td>
                        <td align="left" style="padding: 5px" valign="middle">
                            <asp:TextBox ID="TituloDescricao" runat="server" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="padding: 5px" valign="top" width="150px">
                            Descreva o produto:</td>
                        <td align="left" style="padding: 5px" valign="middle">
        ...
        <asp:View ID="ViewDoacao" runat="server">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td>
                        Cadastro de bancos para doação</td>
                </tr>
                <tr>
                    <td width="150px">
                        &nbsp;</td>
                    ...
                    <td>
                        <asp:Panel ID="PanelListaBanco" runat="server">
                            ...
                            OnRowCommand="BancoRowCommand" 
                                AllowSorting="True" DataSourceID="ods_Doacao" EnableModelValidation="True" 
                            ...
                            <asp:ObjectDataSource ID="ods_Doacao" runat="server" DeleteMethod="Excluir" 
                                OldValuesParameterFormatString="original_{0}" SelectMethod="SelectAll" 
                                TypeName="Actio.Negocio.Doacao">
                                <DeleteParameters>
            ...
            <asp:View ID="v8Vendas" runat="server">
            </asp:View>
            <asp:View ID="v9Clientes" runat="server">
